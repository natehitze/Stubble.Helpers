...
{
    public abstract class HelperTagParserBase<THelperRef> : InlineParser where THelperRef : IHelperRef
    {
        private readonly ImmutableDictionary<string, THelperRef> _helperMap;

        public HelperTagParserBase(ImmutableDictionary<string, THelperRef> helperMap)
        {
